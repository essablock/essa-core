             ...
             public NonMovableOrCopyable
{
  ...
  protected:
    ...
    void recvMessage(EssaBlockChainMessage const& msg);
    void recvMessage(AuthenticatedMessage const& msg);
    void recvMessage(xdr::msg_ptr const& xdrBytes);

    virtual void recvError(EssaBlockChainMessage const& msg);
    void updatePeerRecordAfterEcho();
    void updatePeerRecordAfterAuthentication();
    void recvAuth(EssaBlockChainMessage const& msg);
    void recvDontHave(EssaBlockChainMessage const& msg);
    void recvGetPeers(EssaBlockChainMessage const& msg);
    void recvHello(Hello const& elo);
    void recvPeers(EssaBlockChainMessage const& msg);

    void recvGetTxSet(EssaBlockChainMessage const& msg);
    void recvTxSet(EssaBlockChainMessage const& msg);
    void recvTransaction(EssaBlockChainMessage const& msg);
    void recvGetSCPQuorumSet(EssaBlockChainMessage const& msg);
    void recvSCPQuorumSet(EssaBlockChainMessage const& msg);
    void recvSCPMessage(EssaBlockChainMessage const& msg);
    void recvGetSCPState(EssaBlockChainMessage const& msg);
  ...
  public:
    ...
    void sendMessage(EssaBlockChainMessage const& msg);
