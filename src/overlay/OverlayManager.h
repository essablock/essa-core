 ...
 * `EssaBlockChainMessage`, in the file src/xdr/EssaBlockChain-overlay.x
 *
 ...
 *
 * The `EssaBlockChainMessage` union contains 3 logically distinct kinds of message:
 *
...
class OverlayManager
{
  public:
    ...
    // Herder.
    virtual void broadcastMessage(EssaBlockChainMessage const& msg,
                                  bool force = false) = 0;
    ...
    virtual void recvFloodedMsg(EssaBlockChainMessage const& msg,
                                Peer::pointer peer) = 0;
