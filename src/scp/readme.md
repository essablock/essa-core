# SCP (EssaBlockChain Consensus Protocol)
...
in the file [EssaBlockChain-SCP.x](../xdr/EssaBlockChain-SCP.x)

The `essa-core` program has a single subclass of SCPDriver called
...
For details of the protocol itself, see the [paper on SCP](https://www.essa.org/papers/essa-consensus-protocol.pdf).
