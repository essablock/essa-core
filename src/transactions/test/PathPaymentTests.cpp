...
TEST_CASE("pathpayment", "[tx][pathpayment]")
{
    ...
    SECTION("dest amount too big for ESSA")
    {
    ...
    SECTION("path payment ESSA with not enough funds")
    {
        auto market = TestMarket{*app};
        // see https://github.com/essa/essa-core/pull/1239
        auto minimumAccount =
    ...
    SECTION("path payment over send max ESSA")
    {
        auto market = TestMarket{*app};
    ...
    SECTION("path payment to self ESSA")
    {
        auto market = TestMarket{*app};
    ...
    SECTION("path payment with cycle")
    {
        for_all_versions(*app, [&] {
            ...
            // buying price is
            // always half - so sender buys 8 times as much ESSA
            // as he/she
            // sells (arbitrage).
            // Second cycle involves 3 transaction in which
            // buying price is
            // always two - so sender buys 8 times as much ESSA
            // as he/she
            ...
            auto validateOffer = [&](const TestAccount& account,
                ...
                auto offer =
                    essa::loadOffer(ltx, account.getPublicKey(), offerId);
