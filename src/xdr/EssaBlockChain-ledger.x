...
/* EssaBlockChainValue is the value used by SCP to reach consensus on a given ledger
*/
...
struct LedgerHeader
{
    ...
    EssaBlockChainValue scpValue;   // what consensus agreed to
...
/* Ledger upgrades
note that the `upgrades` field from EssaBlockChainValue is normalized such that
