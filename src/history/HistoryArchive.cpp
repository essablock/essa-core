...
{
    return std::string("essa-history.json");
}
...
HistoryArchiveState::HistoryArchiveState() : server(ESSABLOCKCHAIN_CORE_VERSION)
{
    uint256 u;
...
HistoryArchiveState::HistoryArchiveState(uint32_t ledgerSeq,
    ...
    : server(ESSABLOCKCHAIN_CORE_VERSION), currentLedger(ledgerSeq)
{
