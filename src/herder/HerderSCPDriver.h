...
class HerderSCPDriver : public SCPDriver
{
  public:
    struct ConsensusData
    {
        ...
        EssaBlockChainValue mConsensusValue;
        ConsensusData(uint64_t index, EssaBlockChainValue const& b)
    ...
    void restoreSCPState(uint64_t index, EssaBlockChainValue const& value);
    ...
    void nominate(uint64_t slotIndex, EssaBlockChainValue const& value,
                  TxSetFramePtr proposedSet, EssaBlockChainValue const& previousValue);
  ...
  private:
    ...
    validateValueHelper(uint64_t slotIndex, EssaBlockChainValue const& sv) const;
