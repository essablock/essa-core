...
Two slightly-obscurely-named components are:
  ...
  - SCP -- "EssaBlockChain Consensus Protocol", the component implementing the
    [consensus algorithm](https://www.essa.org/papers/essa-consensus-protocol.pdf).
...
- Set of core validator nodes. Running essa-core only. Tasked with:
...
- Set of public HTTP nodes. Not running essa-core. Running
...
- (optional): Set of public validator nodes. Running essa-core only. Tasked
with:
  ...
  - Basically just a essa-network load balancer / firewall for public access,
