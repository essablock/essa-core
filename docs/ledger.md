...
- **Ledger**: A ledger is the state of the distributed EssaBlockChain database at a
...
- **Ledger header**: The ledger's header contains meta data about the ledger,
  ...
  own hash. (See [`src/xdr/EssaBlockChain-ledger.x`](/src/xdr/EssaBlockChain-ledger.x))


`EssaBlockChain-core` maintains the content of the latest ledger and of the ledger
...
performance needs.
 ...
 4. Finally, `essa-core` can be configured to upload detailed historical
